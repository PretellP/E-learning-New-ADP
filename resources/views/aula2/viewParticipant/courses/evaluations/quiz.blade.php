...
<div class="content global-container quiz">
    ...
    <div class="quiz-container quiz col-12">
        ...
        <div class="card quiz z-index-2">
            ...
            @include('aula2.viewParticipant.courses.evaluations.types.unique_answer')
            @elseif ($type_id == 2)
            @include('aula2.viewParticipant.courses.evaluations.types.multiple_answers')
            @elseif ($type_id == 4)
            @include('aula2.viewParticipant.courses.evaluations.types.fill_in_the_blank')
            @elseif ($type_id == 5)
            @include('aula2.viewParticipant.courses.evaluations.types.matching')
            @endif
