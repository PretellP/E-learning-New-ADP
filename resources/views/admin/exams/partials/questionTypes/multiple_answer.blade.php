...
<div class="form-row statement-points-group">
    ...
    <div class="form-group col-2">
        <label>Puntos *</label>
        <input type="number" name="points" class="form-control points @if(isset($isInvalid)) not-user-allowed @endif"
            value="@if(isset($question)){{ $question->points }}@endif" @if(isset($isInvalid)) readonly='true' @endif>
    </div>
        ...
        <tr class="alternative-row" data-index="{{ $i }}">
            ...
            <td class="text-center flex-center">
                ...
                <div class="custom-checkbox custom-input-height flex-center">
                    ...
                    @endif @if(isset($isInvalid)) readonly='true' @endif>
                    <label for="checkbox-{{ $i }}"
                        class="selectgroup-button selectgroup-button-icon custom-checkbox-question margin-0 @if(isset($isInvalid)) not-user-allowed @endif">
