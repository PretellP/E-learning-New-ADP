...
<div class="row content">
    ...
    <div class="main-container-page">
        <div class="card page-title-container">
            <div class="card-header">
                <div class="total-width-container">
                    <h4>Encuestas: Reporte de perfil de usuario</h4>
                </div>
            </div>
        </div>
        ...
        <div class="card-body card z-index-2 principal-container">
            ...
            <form action="{{ route('admin.download.excel.profile') }}" id="form-survey-report-export" method="GET">
            ...
            <table id="profile-surveys-table" class="table table-hover" data-url="{{ route('admin.surveys.reports.profile.index') }}">
                <thead>
                    <tr>
                        <th>N°</th>
                        <th>DNI</th>
