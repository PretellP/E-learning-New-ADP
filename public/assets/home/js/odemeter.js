...
var Odometer = /** @class */ (function () {
    ...
    Odometer.prototype.render = function (elem, formatted) {
        ...
        var transitionDigit = "transform ".concat(
            options.duration,
            "s ease-out"
        );
        ...
        function appendDigit(cell, newDigit) {
            ...
            if (cell.new) {
                cell.new = false;
                rAF(function () {
                    cell.container.style.transform = "translateY(".concat(
                        cell.position,
                        "em)"
                    );
                });
        ...
        function pushDigit(cell, newDigit) {
            ...
            var now = +new Date();
            var delayTime =
                options.lastDigitDelay * 1000 - (now - cell.lastTimeAdd);
